/*
** Component4081.cpp for cpp_nanotekspice in /Users/leohubertfroideval/Documents/Shared/C++_2016/cpp_nanotekspice/sources/class/component
**
** Made by Leo Hubert Froideval
** Login   <leohubertfroideval@epitech.net>
**
** Started on  Fri Mar 03 17:44:45 2017 Leo Hubert Froideval
** Last update Fri Mar 03 21:22:38 2017 Leo Hubert Froideval
*/
...
nts::Component4081::Component4081(std::vector<struct nts::s_ast_node	*>	 *links,
...
nts::Component4081::Component4081(const nts::Component4081 &obj) : Component(obj)
{
  (void)obj;
}

nts::Component4081 &nts::Component4081::operator=(const nts::Component4081 &obj)
{
  (void)obj;
  return (*this);
}

void nts::Component4081::simulate()
{
  this->pins["3"].value = this->convertBool((this->pins["1"].value && this->pins["2"].value));
  this->pins["4"].value = this->convertBool((this->pins["5"].value && this->pins["6"].value));
  this->pins["10"].value = this->convertBool((this->pins["8"].value && this->pins["9"].value));
  this->pins["11"].value = this->convertBool((this->pins["12"].value && this->pins["13"].value));
}
